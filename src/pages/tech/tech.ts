...
export class TechPage {
    ...
    getOfflineDataToday() {
        this.storage.get("offlineDataTechVandaag").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineDataYesterday() {
        this.storage.get("offlineDataTechGisteren").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineData3DaysAgo() {
        this.storage.get("offlineDataTech3DagenGeleden").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    setOfflineToday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatatech.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataTechVandaag", data);
    ...
    setOfflineYesterday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatatechyesterday.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataTechGisteren", data);
    ...
    setOffline3DaysAgo() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatatech3daysago.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataTech3DagenGeleden", data);
