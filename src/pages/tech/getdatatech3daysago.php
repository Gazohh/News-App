...
// Get TWKS Articles if subscription to TGF is true
if ($TWKS == 1) {
...
WHEN EXISTS (
  ...
  ELSE FALSE END) AS liked FROM article WHERE datum BETWEEN subdate(CURDATE(),3) AND subdate(CURDATE(),2) AND verborgen = 0 AND site = 'Tweakers'";
