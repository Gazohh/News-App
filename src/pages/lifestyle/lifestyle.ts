...
export class LifestylePage {
    ...
    getOfflineDataToday() {
        this.storage.get("offlineDataLifestyleVandaag").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineDataYesterday() {
        this.storage.get("offlineDataLifestyleGisteren").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineData3DaysAgo() {
        this.storage.get("offlineDataLifestyle3DagenGeleden").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    setOfflineToday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatalifestyle.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataLifestyleVandaag", data);
    ...
    setOfflineYesterday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatalifestyleyesterday.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataLifestyleGisteren", data);
    ...
    setOffline3DaysAgo() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatalifestyle3daysago.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataLifestyle3DagenGeleden", data);
