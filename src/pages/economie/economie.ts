...
export class EconomiePage {
    ...
    getOfflineDataToday() {
        this.storage.get("offlineDataEconomieVandaag").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineDataYesterday() {
        this.storage.get("offlineDataEconomieGisteren").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineData3DaysAgo() {
        this.storage.get("offlineDataEconomie3DagenGeleden").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    setOfflineToday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdataeconomie.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataEconomieVandaag", data);
    ...
    setOfflineYesterday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdataeconomieyesterday.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataEconomieGisteren", data);
    ...
    setOffline3DaysAgo() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdataeconomie3daysago.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataEconomie3DagenGeleden", data);
