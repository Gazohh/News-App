...
export class SportPage {
    ...
    getOfflineDataToday() {
        this.storage.get("offlineDataSportVandaag").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineDataYesterday() {
        this.storage.get("offlineDataSportGisteren").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    getOfflineData3DaysAgo() {
        this.storage.get("offlineDataSport3DagenGeleden").then(data => {
            this.items = data;
            this.artikelen = data;
            this.items.sort(function (a, b) {
                const dateA = new Date(a.datum.replace(' ', 'T'));
    ...
    setOfflineToday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatasport.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataSportVandaag", data);
    ...
    setOfflineYesterday() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatasportyesterday.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataSportGisteren", data);
    ...
    setOffline3DaysAgo() {
        if (this.network.type != "none") {
            ...
            this.http
                .post('http://gazoh.net/getdatasport3daysago.php', data, options)
                .subscribe((data: any) => {
                        this.storage.set("offlineDataSport3DagenGeleden", data);
